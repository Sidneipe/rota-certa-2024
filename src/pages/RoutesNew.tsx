...
// import { RouteGroupCard } from '@/components/RouteGroupCard'; // Temporariamente desativado
...
// import { Header } from '@/components/Header'; // Temporariamente desativado
...
export default function RoutesNew() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      {/* <Header /> */} {/* Temporariamente desativado */}
